...
# ------------------------------------------------------------------------------
# Species binomial from a FASTA header. Used by .resolve_alias_collisions()
# (R/screening.R). infer_gene_trees(), which lived here, was removed in 0.5.0: no
# stage of the pipeline called it (see NEWS.md).
# ------------------------------------------------------------------------------
