...
1.  **Data Assembly and Preparation (Modules 1 to 6)**: Mined sequence
    ...
    the Caryophyllales.org checklist
    (`CactaceaeFullList_2026_07_01_Beatriz_Merino.xlsx`; Korotkova *et
    al*. 2021), and concatenation into partitioned supermatrices.
2.  **Phylogenetic Inference and Dating (Modules 7 to 10)**:
    ...
    `RAxML-NG`, Felsenstein Bootstrap Proportions (`FBP`) support
    mapping (with complementary `TBE`), temporal bootstrap generation,
    and penalized likelihood chronogram estimation using `treePL`.
3.  **Visualization and Metadata Integration (Modules 11 and 12)**:
    ...
    (FBP \< 0.70) into soft polytomies, and rendering manuscript-ready
