...
structured into five consecutive analytical parts:

1.  **Molecular Dataset and Alignment Properties (Figures 1 to 3)**:
    Taxonomic marker representation, locus completeness per species, and
    locus occupancy heatmaps.
2.  **Supermatrix Concatenation Structure (Figures 4 to 5)**: Partition
    architecture, boundary coordinates, and parsimony-informative site
    contributions.
3.  **Inferred Phylogeny and Divergence Timescale (Figures 6 to 9)**:
    Maximum-likelihood topology with Felsenstein’s Bootstrap Proportions
    (FBP), high-resolution uncollapsed A0 poster, time-calibrated
    chronogram with 95% HPD intervals, and extended chronogram poster.
4.  **Taxonomic Reconciliation and Species Cadastre (Figure 10)**:
    Global species accounting comparing the taxonomic checklist,
    supermatrix sampling, collapsed duplicates, and phylogenetic
    placement.
5.  **IUCN Conservation and Macroevolutionary Syntheses (Figures 11 to
    17)**: Extinction risk distributions, molecular sampling
    completeness across threat categories, conservation prioritization
    of unsampled gaps, national endemism rankings, threat profiles, and
