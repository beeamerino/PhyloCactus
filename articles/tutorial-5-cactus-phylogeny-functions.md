...
| [`integrate_publication_tree()`](https://beeamerino.github.io/PhyloCactus/reference/integrate_publication_tree.md) | Maps statistical support onto chronograms, collapsing weakly supported nodes (TBE \< 0.70) into **soft polytomies** (*soft polytomies*) to represent analytical uncertainty. | Lemoine *et al.* (2018) |
