...
| [`map_branch_supports()`](https://beeamerino.github.io/PhyloCactus/reference/map_branch_supports.md) | Maps Felsenstein’s Bootstrap Proportions (FBP) and Transfer Bootstrap Expectation (TBE) support values onto the best maximum-likelihood tree. | Felsenstein (1985); Lemoine et al. (2018) |
...
| [`integrate_publication_tree()`](https://beeamerino.github.io/PhyloCactus/reference/integrate_publication_tree.md) | Maps statistical support onto chronograms, collapsing weakly supported nodes (FBP \< 0.70) into soft polytomies to represent analytical uncertainty. | Hillis & Bull (1993) |
