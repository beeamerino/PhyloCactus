...
# The figures on this page are drawn from the reference outputs distributed in inst/extdata.
has_data <- nzchar(system.file("extdata", "phylocactus_table_species.csv", package = "PhyloCactus"))
```
...
The figures on this page are drawn from the reference outputs distributed with the package in `inst/extdata`. The script `tutorial-3-cactus-phylogeny-visualization.R` draws the same figures from the outputs of your own run.
