...
This vignette assumes that you have completed [Tutorial 2: Phylogenetic Inference and Divergence Time Estimation](https://beeamerino.github.io/PhyloCactus/articles/tutorial-2-cactus-phylogeny-inference.html).
...
Across the pipeline, 1,060 species possess sequence data in the multilocus supermatrix (1,022 ingroup and 38 outgroup), while the inferred maximum-likelihood tree and dated chronogram resolve 1,024 terminal tips (986 ingroup and 38 outgroup).
Exactly 36 ingroup species were collapsed by `RAxML-NG` due to identical sequence profiles across their sampled loci.
...
To examine all 1,024 terminal tips without node compression, this visualization formats the complete topology as an A0-dimension poster, displaying individual species binomials and node-level bootstrap support.
...
> Due to its large format dimensions (A0 poster: 36 × 48 inches / 91.4 × 121.9 cm) and 1,024 terminal tips, this extended tree is not rendered inline within this document to maintain browser responsiveness and prevent visual overcrowding.
> 
...
This A0-dimension poster presents the uncollapsed temporal chronogram with all 1,024 tip names, divergence time confidence intervals, and geological period boundaries.
...
> Due to its large format dimensions (A0 poster: 36 × 48 inches / 91.4 × 121.9 cm), 1,024 terminal tips, and node age uncertainty intervals (95% HPD), this extended chronogram is not rendered inline within this document to maintain browser responsiveness.
> 
...
This figure summarizes the methodological composition of the taxonomic universe across pipeline stages, distinguishing taxa that were sampled and dated in the tree (986), sequenced identical duplicates collapsed by `RAxML-NG` (36), unsampled checklist gaps (943), and outgroup reference species (38).
